...
3. Pops up Notepad++ with the latest `Report_*.txt` once the run finishes.
4. Uses a custom 256x256 stock-chart icon (`eod_icon.ico`, generated by `GenerateShortcutIcon.ps1`).
